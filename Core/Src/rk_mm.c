...
{
	if((mm[0].x > -32768) && (mm[0].x < -15000))
		return 1;
	if((mm[0].x > -15000) && (mm[0].x < -5000))
		return 2;
	if((mm[0].x > -5000) && (mm[0].x < -500))
		return 3;
	if((mm[0].x > -500) && (mm[0].x < 500))
		return 4;
	if((mm[0].x > 500) && (mm[0].x < 5000))
		return 5;
	if((mm[0].x > 5000) && (mm[0].x < 15000))
		return 6;
	if((mm[0].x > 15000) && (mm[0].x < 32767))
		return 7;
                       // здесь должна быть обработка данных с магнитометра
	return 0;
}

uint8_t MM_Get_Arm_Pos()
{
	if((mm[1].x > -32768) && (mm[1].x < -15000))
		return 1;
	if((mm[1].x > -15000) && (mm[1].x < -5000))
		return 2;
	if((mm[1].x > -5000) && (mm[1].x < -500))
		return 3;
	if((mm[1].x > -500) && (mm[1].x < 500))
		return 4;
	if((mm[1].x > 500) && (mm[1].x < 5000))
		return 5;
	if((mm[1].x > 5000) && (mm[1].x < 15000))
		return 6;
	if((mm[1].x > 15000) && (mm[1].x < 32767))
		return 7;
                     // здесь должна быть обработка данных с магнитометра
	return 0;
}
